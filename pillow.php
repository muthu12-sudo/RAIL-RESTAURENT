...
<head>
    ...
    <title>Pillow & Blankets | Rail Restaurant | Pure Good Delivery | 24/7 Service | Fastest Food Delivery</title>
...
<body class="rail">
    ...
    <div id="products-container">
        <div class="product">
            <h2>PILLOW</h2>
            <img src="images/pillow.jpg" alt="Pillow">
            <p>₹50<br>For 6 hours</p>
            <div class="quantity">
        ...
        <div class="product">
            <h2>NECK PILLOW</h2>
            <img src="images/npillow.jpg" alt="Neck Pillow">
            <p>₹60<br>For 6 hours</p>
            <div class="quantity">
        ...
        <div class="product">
            <h2>EYE SHADE</h2>
            <img src="images/eyeshade.jpg" alt="Eye Shade">
            <p>₹20<br>For 6 hours</p>
            <div class="quantity">
